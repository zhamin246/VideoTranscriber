                    ...
                    {[
                      {
                        ...
                        body: "This YouTube Transcript Generator accepts public watch pages, Shorts, and youtu.be share links. Add speaker labels and language selection before you start. Private or blocked videos may not download.",
                      ...
                      },
                      {
                        ...
                        body: "After transcription, generate AI notes and key points from the same video. Use chapters, Ask AI, and mind map when you want more structure without replaying the full runtime.",
                        href: YOUTUBE_TRANSCRIPT_GENERATOR_HREF,
              ...
              <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="mx-auto flex w-full max-w-4xl flex-col gap-6 text-center">
                  <h2
                    ...
                    style={{ fontSize: 36, fontWeight: 700, lineHeight: "45px", color: "#000" }}
                  >
                    Turn public YouTube videos into text
                  </h2>
                  <p className="text-lg text-slate-700" style={{ fontSize: 18, lineHeight: "27px" }}>
                    Paste a public link for lectures, tutorials, interviews, or long-form videos.
                    This YouTube Transcript Generator turns it into a searchable transcript you can copy or export as TXT, DOCX, SRT, VTT, or CSV.
                  </p>
                </div>
                  ...
                  {[
                    {
                      ...
                      body: "Turn public lecture and course videos into study notes. AI summaries and chapters help you review hours of material without rewatching every minute.",
                      icon: GraduationCap,
                    },
                    {
                      title: "Tutorials",
                      body: "Capture steps from how-to videos as text you can search. Jump back with timestamps in SRT or VTT when you need the matching moment in an editor.",
                      icon: Youtube,
                    },
                    {
                      title: "Interviews",
                      body: "Transcribe interview uploads on YouTube with optional speaker labels. Quote sources accurately instead of scrubbing the timeline.",
                      icon: Mic,
                    },
                    {
                      title: "Show notes & blogs",
                      body: "Draft show notes, newsletters, and posts from the spoken track. Copy TXT or DOCX into the doc tool you already use.",
                      icon: Newspaper,
                    },
                    {
                      title: "Team research",
                      body: "Share a transcript so teammates can search a talk without watching it twice. Ask AI questions against the same workspace.",
                      icon: Users,
                    },
                    {
                      title: "Captions workflow",
                      body: "Export SRT or VTT when you need a captions file. This is AI transcription of the audio, not a dump of every YouTube caption language track.",
                      icon: AudioLines,
                    },
                  ].map((item) => {
