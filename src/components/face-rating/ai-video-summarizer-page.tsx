...
const CHIP_ICONS = [FileUp, Link2, Sparkles, ListTree, MessageCircleQuestion] as const;
...
export default function AiVideoSummarizerPage() {
  const seo = aiVideoSummarizerSeo;
              ...
              <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="mx-auto mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                  {seo.usecases.items.map((item, i) => {
                    const Icon = [GraduationCap, Users, Newspaper, Podcast, Mic, AudioLines][i] ?? Users;
                    return (
                      <article
                        key={item.title}
